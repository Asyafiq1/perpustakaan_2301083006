          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  title: Text('${pengembalian.namaPeminjam} - ${pengembalian.judulBuku}'),
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      if (pengembalian.terlambat)
                        Text('Denda: Rp ${pengembalian.denda.toStringAsFixed(0)}'),
                    ],
                  ),
                  trailing: Row(
    ...
    return StatefulBuilder(
      builder: (context, setState) {
        ...
        if (selectedPeminjaman != null) {
          final tanggalKembali = DateTime.parse(selectedPeminjaman!['tanggal_kembali']);
          isTerlambat = selectedTanggalDikembalikan.isAfter(tanggalKembali);
          if (isTerlambat) {
            final selisihHari = selectedTanggalDikembalikan.difference(tanggalKembali).inDays;
        ...
        return AlertDialog(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                      DateFormat('dd/MM/yyyy').format(selectedTanggalDikembalikan)
                    ),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                if (formKey.currentState!.validate() && selectedPeminjaman != null) {
                  final newPengembalian = Pengembalian(
                    tanggalDikembalikan: selectedTanggalDikembalikan,
                    terlambat: isTerlambat,
                    denda: denda,
                    peminjamanId: int.parse(selectedPeminjaman!['id'].toString()),
                  );

                  try {
                    await _pengembalianService.createPengembalian(newPengembalian);
